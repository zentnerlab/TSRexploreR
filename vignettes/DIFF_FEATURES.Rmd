...
This example uses a set of STRIPE-seq-detected TSRs from *S. cerevisiae* cells treated with 1.5 mM diamide for 1 hour and their corresponding control cells. Diamide is an oxidizing agent that induces a transcriptional stress response.
